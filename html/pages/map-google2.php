    ...
    <div class="site-menubar-body">
      <div>
        <div>
          ...
          <div class="site-menubar-section" style="margin-top:20px;margin-bottom:20px">
             <h5>
            Distancia (Km)
            <?php 
            if($datosPerfil[9]=="")
          ...
          <h5><br>
            ...
            18&nbsp;<input id="ex2" data-slider-id='ex1Slider' type="text" data-slider-min="18" data-slider-max="55" data-slider-step="1" data-slider-value="<?php echo $edad ?>"/>&nbsp;55
              <br><br>
...
<!--div id="actu" style="text-align: right;width:70%;display:none">
     <a class="avatar" style="width:15px;height:10px;color:#FFFFFF" href="map-google.php">
       Actualizar&nbsp;<img id="addImg" src="../icons/update.png">
     </a>
  </div-->
          </div>
