...
<head>
  ...
  <title>Sesión suspendida | Punto de Encuentro</title>
  ...
  <!-- Page -->
  <link rel="stylesheet" href="../../assets/css/pages/lockscreen.css">
...
<body class="page-locked layout-full page-dark">
  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      ...
      <p class="locked-user"><?php echo $_SESSION["user"] ?></p>
      <!--form method="post" role="form-->
        <div class="input-group" style="width:300px">
          <input type="password" class="form-control" size="60" id="inputPassword" name="password"
          placeholder="Ingresa Contraseña">
          <span class="input-group-btn">
            <button id="unlock" class="btn btn-primary"><i class="icon wb-unlock" aria-hidden="true"></i>
              <span class="sr-only">unLock</span>
            </button>
          </span>
        </div><br>
      <!--/form-->
      <p>Ingresa tu contraseña para reactivar tu sesión</p>
      <p><a class="logout">o ingresa con otro usuario</a></p>
      <div id="result"></div>
