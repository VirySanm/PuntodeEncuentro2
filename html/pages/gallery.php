...
$abumprincipal=abumprincipal($strHostMYSQL,$strUserMYSQL,$strPWDMYSQL,$strDBMYSQL,$_SESSION["iduser"]);
...
cambio(km,edad,sex);
  ...
  <div class="page animsition">
    <div class="page-header page-header-bordered page-header-tabs" id="albuns">
      <ol class="breadcrumb">
      </ol>
      <h1 class="page-title">Fotos</h1>
      <div class="page-header-actions">
      <?php if($abumprincipal>0){
        if($_GET["idalbum"]!=1 && $_GET["idalbum"]!=2){
      	?>
        <a class="btn btn-sm btn-inverse btn-round" id="agregarfotos" title="<?php echo $_GET["idalbum"]?>">
          <i class="icon bd-dropbox" aria-hidden="true"></i>
          <span class="hidden-xs">Agregar Fotos</span>
        </a>
        <?php }?>
        <a class="btn btn-sm btn-inverse btn-round" id="nuevoalbum" title="0">
          <i class="icon bd-dropbox" aria-hidden="true"></i>
      ...
      else
      {
       ...
       ?>
        <li <?php echo $activo?> role="presentation">
          <a class="albumnes" id="<?php echo $row["idalbum"]?>" role="tab" data-filter="*"><?php echo $row["album"]?></a>
        </li>
        <?php } else {?>
        <li role="presentation">
          <a class="albumnes" id="<?php echo $row["idalbum"]?>"  role="tab" data-filter="object"><?php echo $row["album"]?></a>
        </li>
          <?php }
         } } } ?>
      </ul>
    ...
    <?php  if($_GET["idalbum"]!=1 && $_GET["idalbum"]!=2){?>
    <div style="text-align:right;margin-top:-25px">
      <a class="avatar" style="width:25px;height:25px;cursor:pointer">
       <img class="deletealb" id="<?php echo $_GET["idalbum"]; ?>" src="../icons/remove.png" title="Eliminar Album">
      </a>
    </div>
     <?php
         }
      ...
      $strParameters= "host:".$strHostMYSQL."~-user:".$strUserMYSQL."~PWD:".$strPWDMYSQL."bd:".$strDBMYSQL;
          ...
          $str = "select * from imagenes where idalbum=" . $_GET["idalbum"]. " and estatusimg!=2 and iduser=".$_SESSION["iduser"];
          $Res = mysql_query($str);
     ...
     <?php
        ...
        <div class="widget widget-shadow">
          ...
          <figure class="widget-header overlay-hover overlay">
            ...
            <a class="avatar" style="width:20px;height:20px;cursor:pointer">
              <img class="imgportada" id="<?php echo $row["idimg"].",".$row["img"]; ?>" src="../icons/portada.png" title="Elegir como Portada">
            </a>&nbsp;&nbsp;&nbsp;
            <a class="avatar" style="width:20px;height:20px;cursor:pointer">
              <img class="imgperfil" id="<?php echo $row["idimg"].",".$row["img"]; ?>" src="../icons/perfil.png" title="Elegir como Perfil">
            </a>&nbsp;&nbsp;&nbsp;            
            <a class="avatar" style="width:20px;height:20px;cursor:pointer">
              <img class="deleteimg" id="<?php echo $row["idimg"].",".$_GET["idalbum"]; ?>" src="../icons/remove.png" title="Eliminar Foto">
            </a>
            <br><br>
          <input class="coment" id="<?php echo $row["idimg"]?>" title="<?php echo $_GET["idalbum"].",". $row["idimg"].",".$_SESSION["iduser"] ?>" type="text" size="39px" placeholder="Escribir comentario sobre esta Foto">
