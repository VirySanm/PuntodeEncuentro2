    ...
    <div class="page-content vertical-align-middle">
      ...
      <p>Accede a tu cuenta</p>
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Email" value="<?php echo $mail ?>">
        </div>
        <div class="form-group">
          <label class="sr-only" for="inputPassword">Password</label>
          <input type="password" class="form-control" id="inputPassword" name="password" placeholder="Password" value="<?php echo $pass ?>">
        </div>
        <div class="form-group clearfix">
          <div class="checkbox-custom checkbox-inline checkbox-primary pull-left">
            <input type="checkbox" id="inputCheckbox" name="remember" <?php echo $sel?>>
            <label for="inputCheckbox">Recordar</label>
          </div>
          <a class="pull-right" href="forgot-password.html">Olvidaste tu contraseña?</a>
        </div>
        <div id="result"></div>
        <button id="entrar" class="btn btn-primary btn-block">Entrar</button>

      <p>¿no tienes cuenta? Registrate, es gratis. <a href="register.html">Registrar</a></p>
