...
<body class="dashboard" onload="geolocalizame()">
  <!--[if lt IE 8]>
    ...
    <div class="page-content container-fluid">
        ...
        <div class="col-xlg-3 col-lg-4 col-md-12">
          ...
          <div class="widget widget-shadow">
            <div class="widget-content text-center bg-white padding-40">
              ...
              <p class="font-size-20 blue-grey-700">Gabriela Valencia</p>
              <p class="blue-grey-400 margin-bottom-20">Te agrego</p>
              <p class="margin-bottom-35">Tengo 43 años, separada, con dos hijas una de 11 y otra de 8 años, actualmente me dedico al hogar, realice estudios de Educadora, peso 53 Kg., mido 1.59, tez morena clara, cabello castaño oscuro ondulado, mis pasatiempos son pasear...
              ...
              <button type="button" class="btn btn-primary padding-horizontal-40">Revista</button>
            </div>
          </div>
                  ...
                  <div class="counter counter-lg counter-inverse text-left">
                    ...
                    <div class="counter-label">
                      ...
                      <div class="counter counter-sm text-left">
                        ...
                        <?php if($datosPerfil[15]==1)
                        {
                        ?>
                          <span class="counter-number-related font-size-14">Vigencia:&nbsp;&nbsp;<?php echo  $datosPerfil[13] ?></span>
                        <?php }?>  
                        </div>
                      </div>
                    </div>
      ...
      <!--div class="row" data-plugin="matchHeight" data-by-row="true">
        <div class="col-lg-4 col-md-6">
          <-- Panel Revistaers >
          <div class="panel" id="Solicitados">
            <div class="panel-heading">
              <h3 class="panel-title">
              ...
              <ul class="list-group list-group-dividered list-group-full">
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <div class="pull-right">
                        <button type="button" class="btn btn-outline btn-default btn-sm">Revista</button>
                      </div>
                      <div>
                ...
                <li class="list-group-item">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <div class="pull-right">
                        <button type="button" class="btn btn-success btn-default btn-sm"><i class="icon wb-check" aria-hidden="true"></i>Agregar</button>
                      </div>
                      <div>
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title">Encuentros</h3>
            </div>
            <div class="panel-body">
              <ul class="list-group list-group-dividered list-group-full">
                <li class="list-group-item">
                  <small class="label label-round label-info pull-right">Completado</small>
                  <p>
                  ...
                  <small>Opened by
                    <a class="hightlight" href="javascript:void(0)">
                      ...
                      <span>Mario Mayorga</span>
                    </a>
                    <time datetime="2015-07-01T08:55">2 hours ago</time>
                  </small>
                </li>
                <li class="list-group-item">
                  <small class="label label-round label-warning pull-right">Pendeniente</small>
                  <p>
                    <span>Mobile App</span>
                    <span>[13061]</span>
                  </p>
                ...
                <li class="list-group-item">
                  <small class="label label-round label-primary pull-right">En progreso</small>
                  <p>
                    <span>Web App</span>
                    <span>[13062]</span>
                  </p>
                ...
                <li class="list-group-item">
                  <small class="label label-round label-danger pull-right">Rechazado</small>
                  <p>
                    <span>Web App</span>
                    <span>[13063]</span>
                  </p>
