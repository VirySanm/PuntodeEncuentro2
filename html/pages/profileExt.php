    ...
    <div class="row">
          ...
          <div class="widget-header">
            <div class="widget-header-content">
              <a class="avatar avatar-lg">
                <img src="<?php echo $avatarExt ?>"/>
              </a>
              <h4 class="profile-user"><?php echo $nombreusus ?></h4>
               <br><br><br>
              <a href="galleryExt.php?idalbum=1&iduser=<?php echo $_GET["iduser"]?>"><button type="button" class="btn btn-primary">Fotos</button></a>
            </div>
          </div>
      ...
      <div class="panel">
        <div class="panel-body nav-tabs-animate">
          <h3 class="page-title">Informaci&oacute;n de Usuario </h3><br>
            <div class="col-lg-12"><br>
              <label class="col-lg-4 control-label">Sobre mi:</label>
                <div class="col-lg-7">
                   <?php echo $datosPerfil[0] ?>
                </div>
            </div>
            <div class="col-lg-12"><br>
              <label class="col-lg-4 control-label">Fecha de Nacimiento:</label>
                ...
                <div class="col-lg-7" style="padding-right: 0px">
                  ...
                  <?php
                        $mes=date('F', mktime(0, 0, 0, $datosPerfil[2], 1, date("Y") ) );
                       ...
                       ?>
                    <?php echo $datosPerfil[1]. " de ".$mes." de ".$datosPerfil[3]?>
                  </div>
            ...
            <div class="col-lg-12"><br>
              ...
              <div class="col-lg-8">
                <?php echo $datosPerfil[4]?>
              </div>
            </div>
            <div class="col-lg-12"><br>
              <label class="col-lg-4 control-label">Profesi&oacute;n:</label>
              <div class="col-lg-7" style="padding-right: 0px">
                <?php echo $datosPerfil[5] ?>
              </div> 
              		
            </div>
            <?php 
           $confirmarusu=usuconfir($strHostMYSQL,$strUserMYSQL,$strPWDMYSQL,$strDBMYSQL, $_GET["iduser"]);
            
            if($confirmarusu==1)
            {
            ?>
             <div class="profile-social" id="result"></div>
              <div class="col-lg-12"><br>
               <label class="col-lg-4 control-label">Medios de Contacto:</label>
               ...
               <?php
                ...
                if(mysql_errno()>0)
                {
                    ...
                    $str = "select *from redessociales where nomcorto!='mobile' and nomcorto!='envelope' and estatusRS=0 and iduser=".$_GET["iduser"];
                    $Res = mysql_query($str);
                    ...
                    if (mysql_errno() > 0) {
                        ...
                        while ($row = mysql_fetch_array($Res)) {
						       ?>
                            <a class="icon bd-<?php echo $row["nomcorto"] ?>"  href="<?php echo $row["red"] ?>" target="_blank"  style="padding-top: 0px" id="pp<?php echo $row["idredsoc"] ?>"></a>
						       <?php 
                        }
                    }
                }
              ...
              <div class="col-lg-12"><br>
               ...
               <div class="col-lg-8" style="padding-right: 0px">
                ...
                if(mysql_errno()>0)
                {
                    ...
                    $str = "select *from redessociales where  nomcorto='mobile' and estatusRS=0 and iduser=".$_GET["iduser"];
                    $Res = mysql_query($str);
                    ...
                    if (mysql_errno() > 0) {
                        ...
                        while ($row = mysql_fetch_array($Res)) {
						              ?>
                            <b class="icon wb-<?php echo $row["idredsoc"] ?>" style="padding-top: 0px" id="pp'<?php echo $row["idredsoc"] ?>">&nbsp;&nbsp;<?php echo $row["red"] ?></b>&nbsp;&nbsp;<br>
                       <?php 
                         }
                    }
                }
              ...
              <div class="col-lg-12"><br>
               ...
               <?php
                ...
                if(mysql_errno()>0)
                {
                    ...
                    $str = "select *from redessociales where nomcorto='envelope' and estatusRS=0 and iduser=".$_GET["iduser"];
                    $Res = mysql_query($str);
                    ...
                    if (mysql_errno() > 0) {
                        ...
                        while ($row = mysql_fetch_array($Res)) {
						          ?>
                            <b class="icon wb-<?php echo $row["nomcorto"] ?>" style="padding-top: 0px" id="pp<?php echo $row["idredsoc"] ?>">&nbsp;&nbsp;<?php echo $row["red"] ?></b>&nbsp;&nbsp;<br>
                        <?php 
                        }
                    }
                }
            ...
            <div class="col-lg-12"><br>
              <div class="pull-center" id="btn<?php echo $_GET["iduser"] ?>">
                <label class="col-lg-4 control-label">Para ver los medios de contacto agregarlo a su Revista</label><br>
...
<!--div class="page animsition"  style="text-align:center">
  ...
  <div class="page-content container-fluid">
    <div class="row">
      ...
      <br>
       <div class="widget-header" style="padding-top: 0px;background-color:transparent">
        <div class="widget-header-content">
          <a class="avatar avatar-lg">
...
<!-- End Page -->
       ...
       <input id="pendnotis" type="text" value="<?php echo $not[0]?>">
...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script> 
   ...
   function pedirPosicion(pos) {
	 ...
	 //alert(pos.coords.latitude+ ","+pos.coords.longitude+" Rango de localizaci�n de +/- "+pos.coords.accuracy+" metros");
